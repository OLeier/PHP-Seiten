<?php
  ...
  // https://www.ib-leier.net/dns/dynip.php?ip=<ipaddr>&client=fb1
  /*
   * 2018-06-29 - htmlentities added
   * 2018-06-27 - first version with mysqli_real_escape_string
   */
  ...
  $host_name = 'db742330692.db.1and1.com';
  $database = 'db742330692';
  $user_name = 'dbo742330692';
  $password = 'GoyP8tGCV6OvNblKLZYV';
